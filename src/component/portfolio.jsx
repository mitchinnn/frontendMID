...
<section id="portfolio" className="portfolio section-bg">
  <div className="container">
    <div className="section-title">
      <h2>Portfolio</h2>
      <p>Saya adalah seorang pengembang frontend yang kreatif dan berfokus pada pengalaman pengguna. Portofolio saya mencerminkan kemampuan saya dalam menciptakan desain responsif yang memikat, menghadirkan antarmuka yang menarik di berbagai perangkat</p>
    </div>
